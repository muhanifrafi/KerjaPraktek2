	...
	public function showPagePopUp($totalData, $numToDisplay, $currentPage, $modul)
	{
			...
			<div class=\"col-sm-6\">
				<div class=\"dataTables_paginate paging_simple_numbers\" id=\"dataTables-example_paginate\">
					...
					$aprev = $currentPage -1;
						$keluaran =  $keluaran . "
							<li class=\"paginate_button previous\" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_previous\">
								<a href=\"#\"  onClick=\"javascript:gantinewPagePopUp('$modul','$aprev');\">Previous</a>
							</li>";
		...
		else
		{
			for($a=$indexStartPage; $a<=$indexEndPage; $a++)
			{
							...
							$keluaran =  $keluaran . "
								<li class=\"paginate_button next\" aria-controls=\"dataTables-example\" tabindex=\"0\" 
								id=\"dataTables-example_next\" onClick=\"javascript:gantinewPagePopUp('$modul','$anext');\"><a href=\"#\">Next</a></li>";
							}
							else{
							$keluaran =  $keluaran . "
								<li class=\"paginate_button next disabled\" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\"><a href=\"#\">Next</a></li>";							
