...
class paging {
	...
	public function showPagePopUp($totalData, $numToDisplay, $currentPage, $modul)
	{
		$totalPages = $this->pager($totalData, $numToDisplay);
		$totalPerPages = 5;
		$totalGroup = $totalPages / $totalPerPages ;
			...
			<div class=\"col-sm-6\">
				<div class=\"dataTables_paginate paging_simple_numbers\" id=\"dataTables-example_paginate\">
					...
					$aprev = $currentPage -1;
						$keluaran =  $keluaran . "
							<li class=\"paginate_button previous\" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_previous\">
								<a href=\"#\"  onClick=\"javascript:gantinewPagePopUp('$modul','$aprev');\"><i class=\"fa fa-angle-double-left\"></i></a>
							</li>";
		...
		if($totalPages <= $indexEndPage)
		{
							for($a=$indexStartPage; $a <= $totalPerPages; $a ++)
							{
								...
								$keluaran =  $keluaran . "
								<li class=\"paginate_button\" aria-controls=\"dataTables-example\" tabindex=\"0\">
										<a href=\"#\" onClick=\"javascript:gantinewPagePopUp('$modul','$a');\">$a</a>
								</li>";
								}	
							}
		}
		else
		{
			for($a=$indexStartPage; $a<=$indexEndPage; $a++)
			{
							...
							$keluaran =  $keluaran . "
								...
								id=\"dataTables-example_ellipsis\"><a href=\"#\">...</a></li>
								<li class=\"paginate_button\" aria-controls=\"dataTables-example\" tabindex=\"0\">
									<a href=\"#\"  onClick=\"javascript:gantinewPagePopUp('$modul','$a');\">$totalPages</a>
								</li>
								<li class=\"paginate_button next\" aria-controls=\"dataTables-example\" tabindex=\"0\" 
								id=\"dataTables-example_next\" onClick=\"javascript:gantinewPagePopUp('$modul','$anext');\"><a href=\"#\"><i class=\"fa fa-angle-double-right\"></i></a></li>";
...
function gantinewPagePopUp(modul,currentPage)
{
	var opt = {currentPage : currentPage};
	jQuery.get(modul,opt,function(data) {
		jQuery("#popuptarget").html(data);
	});
}
</script>
