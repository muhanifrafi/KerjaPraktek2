...
class oa_page {
    ...
    public function showPage20($totalData, $numToDisplay, $currentPage, $modul, $fungsi, $param1, $param2, $param3, $param4, $param5, $param6, $param7, $param8, $param9, $param10, $param11, $param12, $param13, $param14, $param15, $param16, $param17, $param18, $param19, $param20
        ...
        if ($totalPages == 1) {
            ...
            $keluaran = $keluaran . " 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto25('$modul','$totalPages','$fungsi', 
																													...
																													'$param16', '$param17','$param18', '$param19', '$param20'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> : ";
        }
        ...
        if ($currentPage > 1) {
            $a = 1;
            $keluaran = $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage20('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10',
																										'$param11','$param12', '$param13', '$param14', '$param15', 
																										'$param16', '$param17','$param18', '$param19', '$param20');\"><strong>&#60;&#60;</strong><span class=\"page-sep\"> </span></a>&nbsp;";
        }
        ...
        if ($totalPages <= $indexEndPage) {
            ...
            for ($a = $indexStartPage; $a <= $totalPages; $a++) {
                if ($a == $currentPage)
                    ...
                    $keluaran = $keluaran . "<span><a href=\"#pageCursor\" onClick=\"javascript:gantinewPage20('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																												'$param11','$param12', '$param13', '$param14', '$param15', 
																												'$param16', '$param17','$param18', '$param19', '$param20');\">&nbsp;$a&nbsp;</a><span class=\"page-sep\"> </span></span>";
                }
            }
            ...
            if ($currentPage < $totalPages) {
                ...
                $keluaran = $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage20('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																									'$param11','$param12', '$param13', '$param14', '$param15', 
																									'$param16', '$param17','$param18', '$param19', '$param20');\"><strong>&#62;</strong></a>";
            }
        } else {
            for ($a = $indexStartPage; $a <= $indexEndPage; $a++) {
                if ($a == $currentPage)
            ...
            if ($currentPage <= $totalPages) {
                ...
                $keluaran = $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage20('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																													'$param11','$param12', '$param13', '$param14', '$param15', 
																													'$param16', '$param17','$param18', '$param19', '$param20');\">&#62;&#62;<span class=\"page-sep\"> </span></a>&nbsp;";
            }
        }
    ...
    public function showPage25($totalData, $numToDisplay, $currentPage, $modul, $fungsi, $param1, $param2, $param3, $param4, $param5, $param6, $param7, $param8, $param9, $param10, $param11, $param12, $param13, $param14, $param15, $param16, $param17, $param18, $param19, $param20, $param21, $param22, $param23, $param24, $param25, $param26
    ) {
        $totalPages = $this->pager($totalData, $numToDisplay);
        $totalPerPages = 5;
        $totalGroup = $totalPages / $totalPerPages;
